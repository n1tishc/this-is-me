import { GraduationCap, Mail, Link as LinkIcon, type LucideProps } from 'lucide-react'
...
export function Icon({ name, ...props }: { name: string } & LucideProps) {
  const Cmp = iconMap[name as IconName] ?? LinkIcon
  return <Cmp {...props} />
}
